...
package iotCore.awsIotCore.sampleUtil;
...
public class SampleUtil {
    ...
    public static KeyStorePasswordPair getKeyStorePasswordPair(final String bucketName, final String certificateFile, final String privateKeyFile) {
        return getKeyStorePasswordPair(bucketName, certificateFile, privateKeyFile, null);
    }
    ...
    public static KeyStorePasswordPair getKeyStorePasswordPair(final String bucketName, final String certificateFile, final String privateKeyFile,
        ...
        final PrivateKey privateKey = loadPrivateKeyFromFile(bucketName, privateKeyFile, keyAlgorithm);

        final List<Certificate> certChain = loadCertificatesFromFile(bucketName, certificateFile);
    ...
    private static List<Certificate> loadCertificatesFromFile(final String bucketName, final String filename) {
...
//        }
        ...
        try (
                ...
                BufferedInputStream stream = new BufferedInputStream(object.getObjectContent())
        ) {
    ...
    private static PrivateKey loadPrivateKeyFromFile(final String bucketName, final String filename, final String algorithm) {
...
//        }
        ...
        try (
                S3Object object = s3.getObject(new GetObjectRequest(bucketName, filename));
                DataInputStream stream = new DataInputStream(object.getObjectContent())
        ) {
